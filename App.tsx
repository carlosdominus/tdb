...
const App: React.FC = () => {
  ...
  if (!state.isLoggedIn && currentView !== View.LOGIN) {
    return <LoginView onLogin={handleLogin} />;
  }
  ...
  return (
    <div className="min-h-screen pb-24 md:pb-0 md:pt-16">
      ...
      {currentView !== View.LOGIN && currentView !== View.ONBOARDING && (
      ...
      <main className={`max-w-4xl mx-auto px-6 animate-in fade-in duration-500 ${currentView === View.LOGIN || currentView === View.ONBOARDING ? 'pt-0 pb-0' : 'pt-28 pb-20 md:py-16'}`}>
        {renderView()}
      </main>
